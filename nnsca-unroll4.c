        ...
        for (n = 0;  n < count;  n++)
        {
                ...
                for (tn = 0;  tn < trcountU;  tn += 4)
                {
                        ...
                        for (d = 0;  d < dimensions;  d++)
                        {
                                ...
                                mask2 = tmp2 >> (sizeof(char) * CHAR_BIT - 1);
        ...
        for (n = 0;  n < count;  n++)
        {
                ...
                for (tn = 0;  tn < trcountU;  tn += 4)
                {
                        ...
                        for (d = 0;  d < dimensions;  d++)
                        {
                                ...
                                tmp3 = datum - trdata[ti3 + d];
                                tmp4 = datum - trdata[ti4 + d];
                                mask1 = tmp1 >> (sizeof(short) * CHAR_BIT - 1);
                                mask2 = tmp2 >> (sizeof(short) * CHAR_BIT - 1);
        ...
        for (n = 0;  n < count;  n++)
        {
                ...
                for (tn = 0;  tn < trcountU;  tn += 4)
                {
                        ...
                        for (d = 0;  d < dimensions;  d++)
                        {
                                ...
                                tmp3 = datum - trdata[ti3 + d];
                                tmp4 = datum - trdata[ti4 + d];
                                mask1 = tmp1 >> (sizeof(int) * CHAR_BIT - 1);
                                mask2 = tmp2 >> (sizeof(int) * CHAR_BIT - 1);
                     ...
                     int count, float *data, int *klass)
{
        ...
        for (n = 0;  n < count;  n++)
        {
                ...
                for (;  tn < trcount;  tn++)
                {
                        ...
                        dist1 = 0.0f;
                        for (d = 0;  d < dimensions;  d++)
                                dist1 += fabs(data[i + d] - trdata[ti1 + d]);
                        if (dist1 < min_distance)
                        {
                                min_distance = dist1;
                                cl = trklass[tn];
